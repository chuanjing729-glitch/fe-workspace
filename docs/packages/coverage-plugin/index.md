...
- [**变更日志 (Changelog)**](https://github.com/chuanjing729-glitch/fe-workspace/blob/main/packages/coverage-plugin/CHANGELOG.md): 版本更新记录。
...
import coverage from '@51jbs/coverage-plugin/vite';
...
```javascript
// rspack.config.js
const { rspackCoveragePlugin } = require('@51jbs/coverage-plugin/rspack');
