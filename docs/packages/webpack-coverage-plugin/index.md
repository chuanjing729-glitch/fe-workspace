...
- [**变更日志 (Changelog)**](https://github.com/chuanjing729-glitch/fe-workspace/blob/main/packages/webpack-coverage-plugin/CHANGELOG.md): 版本更新记录。
