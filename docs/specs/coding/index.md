...
### [JavaScript/TypeScript 规范](/specs/coding/javascript)
...
- [工程化规范](/specs/engineering/) - Git工作流、代码审查、测试规范
- [设计规范](/specs/design/) - 技术方案设计、架构设计
- [优化规范](/specs/optimization/) - 性能优化、内存管理
