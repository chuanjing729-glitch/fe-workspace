...
PLUGIN_PATH="/Users/chuanjiing.li/Documents/51jbs/project/fe-efficiency/packages/webpack-spec-plugin"
...
npm link "$PLUGIN_PATH" 2>/dev/null || {
  ...
  cp -r "$PLUGIN_PATH" node_modules/@51jbs/webpack-spec-plugin
}
echo "✅ 插件链接成功"
echo ""
